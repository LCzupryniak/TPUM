namespace Client.Presentation.Model.API
{
    public interface ICustomerModelService
    {
        ...
        public abstract void AddCustomer(Guid id, string name, float money, Guid inventoryId);
        public abstract bool RemoveCustomer(Guid id);
        public abstract bool UpdateCustomer(Guid id, string name, float money, Guid inventoryId);
